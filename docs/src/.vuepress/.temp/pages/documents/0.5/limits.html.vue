...
<li>
<p><s>不能使用可空类型修饰符(?)</s></p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code><span class="token keyword">int</span><span class="token operator">?</span> a <span class="token operator">=</span> null<span class="token punctuation">;</span><span class="token comment">//这种在热更里已经支持了</span>
...
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code><span class="token keyword">volatile</span> <span class="token keyword">int</span> number<span class="token punctuation">;</span><span class="token comment">//这种在热更里也不行</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>委托只能调用<code>Invoke</code>方法</p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>Delegate<span class="token punctuation">.</span><span class="token function">BeginInvoke</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span><span class="token comment">//会出错</span>
...
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">region</span> <span class="token expression">本地工程</span></span>
public class Generic<span class="token operator">&lt;</span>T<span class="token operator">></span><span class="token punctuation">{</span><span class="token punctuation">}</span>
public class Data<span class="token punctuation">{</span><span class="token punctuation">}</span>
...
<span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">region</span> <span class="token expression">热更工程</span></span>
public class HotData<span class="token punctuation">{</span><span class="token punctuation">}</span>
...
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">{</span>
      ...
      Generic<span class="token operator">&lt;</span>HotData<span class="token operator">></span> d <span class="token operator">=</span> new Generic<span class="token operator">&lt;</span>HotData<span class="token operator">></span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
      var json <span class="token operator">=</span> JsonMapper<span class="token punctuation">.</span><span class="token function">ToJson</span><span class="token punctuation">(</span>d<span class="token punctuation">)</span><span class="token punctuation">;</span><span class="token comment">//OK</span>

      <span class="token comment">//序列化本地泛型类型，泛型参数为本地类型，是没问题的</span>
      Generic<span class="token operator">&lt;</span>Data<span class="token operator">></span> d2 <span class="token operator">=</span> new Generic<span class="token operator">&lt;</span>Data<span class="token operator">></span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
      var json2 <span class="token operator">=</span> JsonMapper<span class="token punctuation">.</span><span class="token function">ToJson</span><span class="token punctuation">(</span>d2<span class="token punctuation">)</span><span class="token punctuation">;</span><span class="token comment">//OK</span>

      <span class="token comment">//反序列化Generic&lt;HotData> v0.6.2开始就支持了</span>
      d <span class="token operator">=</span> JsonMapper<span class="token punctuation">.</span>ToObject<span class="token operator">&lt;</span>Generic<span class="token operator">&lt;</span>HotData<span class="token operator">>></span><span class="token punctuation">(</span>json<span class="token punctuation">)</span><span class="token punctuation">;</span><span class="token comment">//v0.6.2开始就支持了</span>
      
      <span class="token comment">//反序列化Generic&lt;Data>可以的</span>
      d2 <span class="token operator">=</span> JsonMapper<span class="token punctuation">.</span>ToObject<span class="token operator">&lt;</span>Generic<span class="token operator">&lt;</span>Data<span class="token operator">>></span><span class="token punctuation">(</span>json2<span class="token punctuation">)</span><span class="token punctuation">;</span><span class="token comment">//OK</span>
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
<span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">endregion</span></span>
