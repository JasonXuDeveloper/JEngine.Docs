...
<h1 id="jbehaviour-v0-6" tabindex="-1"><a class="header-anchor" href="#jbehaviour-v0-6" aria-hidden="true">#</a> JBehaviour（v0.6）</h1>
...
<p>下一篇，<RouterLink to="/documents/0.6/jresource-v0-6.html">资源加载JResource教程</RouterLink></p>
</blockquote>
</template>
