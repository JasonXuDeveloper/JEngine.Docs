...
<h1 id="开发须知-v0-6" tabindex="-1"><a class="header-anchor" href="#开发须知-v0-6" aria-hidden="true">#</a> 开发须知（v0.6）</h1>
...
<ul>
<li>
<p>进入顶部导航栏-&gt;JEngine-&gt;Setting，打开面板后点击<code>更新JEngine</code>按钮，然后按提示的操作</p>
<blockquote>
...
<blockquote>
<p>下一步，<RouterLink to="/documents/0.6/limits.html">ILRuntime限制</RouterLink></p>
</blockquote>
</template>
