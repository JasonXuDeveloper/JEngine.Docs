...
<h1 id="内存加密结构-v0-6" tabindex="-1"><a class="header-anchor" href="#内存加密结构-v0-6" aria-hidden="true">#</a> 内存加密结构（v0.6）</h1>
...
<blockquote>
<p>下一篇，<RouterLink to="/documents/0.6/jprefab-v0-6.html">热更预制体JPrefab教程</RouterLink></p>
</blockquote>
</template>
