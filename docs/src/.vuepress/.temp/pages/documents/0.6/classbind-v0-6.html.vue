...
<h1 id="挂载代码-v0-6" tabindex="-1"><a class="header-anchor" href="#挂载代码-v0-6" aria-hidden="true">#</a> 挂载代码（v0.6）</h1>
...
<blockquote>
<p>下一步，<RouterLink to="/documents/0.6/guide-v0-6.html">开发须知</RouterLink></p>
</blockquote>
</template>
