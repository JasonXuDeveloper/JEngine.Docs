...
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>using JEngine<span class="token punctuation">.</span>UI<span class="token punctuation">;</span><span class="token comment">//大部分是这个命名空间</span>
using JEngine<span class="token punctuation">.</span>UI<span class="token punctuation">.</span>UIKit<span class="token punctuation">;</span><span class="token comment">//UIMgr在这个命名空间（一般不需要使用）</span>
using JEngine<span class="token punctuation">.</span>UI<span class="token punctuation">.</span>ResKit<span class="token punctuation">;</span><span class="token comment">//ResMgr在这个命名空间（一般不需要使用）</span>
...
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>UIMgr<span class="token punctuation">.</span>Instance<span class="token punctuation">.</span><span class="token function">Register</span><span class="token punctuation">(</span>
...
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>UIRootView<span class="token punctuation">.</span><span class="token function">InitUIRoot</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>显示<code>UIView</code></p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>UIMgr<span class="token punctuation">.</span>Instance<span class="token punctuation">.</span><span class="token function">ShowUI</span><span class="token punctuation">(</span>JTestViewPath<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>例子</p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public class JumpToUIDemo <span class="token operator">:</span> JBehaviour
<span class="token punctuation">{</span>
  <span class="token comment">/// &lt;summary> class binding &lt;/summary></span>
  public GameObject btn_JumpTo<span class="token punctuation">;</span>

  <span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">region</span> <span class="token expression">声明界面</span></span>
  public <span class="token keyword">static</span> string JTestViewPath <span class="token operator">=</span> <span class="token string">"uiview_testView"</span><span class="token punctuation">;</span>
  public <span class="token keyword">static</span> string JBtnViewPath <span class="token operator">=</span> <span class="token string">"uiview_btnview"</span><span class="token punctuation">;</span>
  ...
  private <span class="token keyword">void</span> <span class="token function">OnJumpToDemo</span><span class="token punctuation">(</span>GameObject go<span class="token punctuation">,</span> PointerEventData eventData<span class="token punctuation">)</span>
  <span class="token punctuation">{</span>
    JResource<span class="token punctuation">.</span><span class="token function">LoadSceneAsync</span><span class="token punctuation">(</span><span class="token string">"UIDemo.unity"</span><span class="token punctuation">,</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=</span><span class="token operator">></span>
                             <span class="token punctuation">{</span>
...
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public override <span class="token keyword">void</span> <span class="token function">Refer</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>[API] 打开面板函数</p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public <span class="token keyword">void</span> <span class="token function">ShowUI</span><span class="token punctuation">(</span>string uiName<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public <span class="token keyword">void</span> <span class="token function">ShowUI</span><span class="token punctuation">(</span>string uiName<span class="token punctuation">,</span> Action<span class="token operator">&lt;</span>APanelBase<span class="token operator">></span> openCall<span class="token punctuation">,</span> Action<span class="token operator">&lt;</span>APanelBase<span class="token operator">></span> closeCall<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>[API] 预加载界面函数</p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public virtual <span class="token keyword">void</span> <span class="token function">PreLoadUI</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>[API] 清理界面函数</p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public virtual <span class="token keyword">void</span> <span class="token function">Clear</span><span class="token punctuation">(</span><span class="token punctuation">)</span>  
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>[API] 界面的销毁函数</p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public virtual <span class="token keyword">void</span> <span class="token function">Destroy</span><span class="token punctuation">(</span><span class="token punctuation">)</span>  
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>[API] 界面的关闭函数</p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public virtual <span class="token keyword">void</span> <span class="token function">CloseUI</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>[生命周期函数] 在界面实例化的时候调用一次，类似<code>Awake</code>,<code>Start</code></p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public virtual <span class="token keyword">void</span> <span class="token function">Init</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>[生命周期函数] 界面每次被打开时自动调用，也可以外部调用刷新</p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public virtual <span class="token keyword">void</span> <span class="token function">Refresh</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>[生命周期函数] 在<code>Refresh()</code>后执行，用做清理还原面板上数据</p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public virtual <span class="token keyword">void</span> <span class="token function">ResetUI</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>[生命周期函数] 界面的帧刷新函数</p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public virtual <span class="token keyword">void</span> <span class="token function">Update</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>[生命周期函数] 界面的帧刷新函数</p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public virtual <span class="token keyword">void</span> <span class="token function">LateUpdate</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
</ul>
...
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public class JTestView <span class="token operator">:</span> APanelBase
<span class="token punctuation">{</span>
    <span class="token comment">//每个界面面板依赖于单例模式</span>
    public <span class="token keyword">static</span> JTestView Instance <span class="token punctuation">{</span> get <span class="token punctuation">{</span> <span class="token keyword">return</span> Singleton<span class="token operator">&lt;</span>JTestView<span class="token operator">></span><span class="token punctuation">.</span>Instance<span class="token punctuation">;</span> <span class="token punctuation">}</span> <span class="token punctuation">}</span>

    <span class="token comment">/// &lt;summary></span>
    <span class="token comment">/// 声明存放位置，属于什么类型的面板</span>
    <span class="token comment">/// &lt;/summary></span>
    public <span class="token function">JTestView</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">:</span> <span class="token function">base</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
    <span class="token punctuation">{</span>
        isFilm <span class="token operator">=</span> true<span class="token punctuation">;</span>
    ...
    <span class="token comment">/// &lt;summary></span>
    <span class="token comment">/// 关联注册函数</span>
    <span class="token comment">/// &lt;/summary></span>
    public override <span class="token keyword">void</span> <span class="token function">Refer</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
    <span class="token punctuation">{</span>
        base<span class="token punctuation">.</span><span class="token function">Refer</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    ...
    <span class="token comment">/// &lt;summary></span>
    <span class="token comment">/// 初始化函数，相当于Awake</span>
    <span class="token comment">/// &lt;/summary></span>
    public override <span class="token keyword">void</span> <span class="token function">Init</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
    <span class="token punctuation">{</span>
        base<span class="token punctuation">.</span><span class="token function">Init</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
    
    <span class="token comment">/// &lt;summary></span>
    <span class="token comment">/// 帧函数</span>
    <span class="token comment">/// &lt;/summary></span>
    public override <span class="token keyword">void</span> <span class="token function">Update</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
    <span class="token punctuation">{</span>
        base<span class="token punctuation">.</span><span class="token function">Update</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token punctuation">}</span>

    <span class="token comment">/// &lt;summary></span>
    <span class="token comment">/// 周期函数，界面打开会自动执行一次</span>
    <span class="token comment">/// &lt;/summary></span>
    public override <span class="token keyword">void</span> <span class="token function">Refresh</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
    <span class="token punctuation">{</span>
        base<span class="token punctuation">.</span><span class="token function">Refresh</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token punctuation">}</span>

    <span class="token comment">/// &lt;summary></span>
    <span class="token comment">/// 周期函数，界面关闭会自动执行，</span>
    <span class="token comment">/// 也可以外部调用，进行关闭面板</span>
    <span class="token comment">/// &lt;/summary></span>
    public override <span class="token keyword">void</span> <span class="token function">CloseUI</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
    <span class="token punctuation">{</span>
        base<span class="token punctuation">.</span><span class="token function">CloseUI</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
...
<li>
<p>内部字段</p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>protected internal GameObject m_gameobj <span class="token operator">=</span> null<span class="token punctuation">;</span>
protected internal Transform Trans <span class="token operator">=</span> null<span class="token punctuation">;</span>
protected internal RectTransform RectTrans <span class="token operator">=</span> null<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div></li>
<li>
<p>[生命周期函数] 初始化子部件，只执行一次</p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public virtual <span class="token keyword">void</span> <span class="token function">setObj</span><span class="token punctuation">(</span>GameObject obj<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>[API] 刷新子部件，注意区分<code> Refresh()</code></p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public virtual <span class="token keyword">void</span> Refresh<span class="token operator">&lt;</span>T<span class="token operator">></span><span class="token punctuation">(</span>T data<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>[API] 刷新子部件，注意区分 <code>Refresh&lt;T&gt;(T data)</code></p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public virtual <span class="token keyword">void</span> <span class="token function">Refresh</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span> <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>[API] 帧刷新，非生命周期</p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public virtual <span class="token keyword">void</span> <span class="token function">Update</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span> <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>[API] 清理</p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public virtual <span class="token keyword">void</span> <span class="token function">Clear</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span> <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>[属性] 判断子部件是否打开</p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public virtual bool IsActive
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
</ul>
...
<li>
<p>[API] 打开界面的统一入口</p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public <span class="token keyword">void</span> <span class="token function">ShowUI</span><span class="token punctuation">(</span>string uibaseName<span class="token punctuation">,</span> bool isSaveShow <span class="token operator">=</span> false<span class="token punctuation">,</span> Action<span class="token operator">&lt;</span>APanelBase<span class="token operator">></span> closeCall <span class="token operator">=</span> null<span class="token punctuation">,</span> Action<span class="token operator">&lt;</span>APanelBase<span class="token operator">></span> openCall <span class="token operator">=</span> null<span class="token punctuation">,</span> bool isClearAll <span class="token operator">=</span> true<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>[API] 设定打开或者关闭已开UI</p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public <span class="token keyword">void</span> <span class="token function">SetShowAllOpenUI</span><span class="token punctuation">(</span>bool isOpen<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>[API] 预加载某个面板</p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public <span class="token keyword">void</span> <span class="token function">PreLoadUI</span><span class="token punctuation">(</span>string uibaseName<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>[API] 获得某个面板</p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public APanelBase <span class="token function">GetUI</span><span class="token punctuation">(</span>string uibaseName<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>[API] 删除某个面板</p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public <span class="token keyword">void</span> <span class="token function">DestoryUI</span><span class="token punctuation">(</span>string uibaseName<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>[API] 关闭并删除某个面板</p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public <span class="token keyword">void</span> <span class="token function">CloseAndDestoryUI</span><span class="token punctuation">(</span>string uibaseName<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>[API] 判断面板是否打开</p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public bool <span class="token function">IsOpen</span><span class="token punctuation">(</span>string planeName<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>[API] 判断面板是否存在</p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public bool <span class="token function">InHavePanel</span><span class="token punctuation">(</span>string planeName<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>[API] 关闭某个面板</p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public <span class="token keyword">void</span> <span class="token function">CloseUI</span><span class="token punctuation">(</span>string uibaseName<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>[API] 关闭所有打开面板(排除设置为保持状态的)</p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public <span class="token keyword">void</span> <span class="token function">CloseAllUI</span><span class="token punctuation">(</span>bool isFilm<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>[API] 帧刷新</p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>public <span class="token keyword">void</span> <span class="token function">Update</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
</ul>
...
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>Image img <span class="token operator">=</span> UIUtility<span class="token punctuation">.</span>GetComponent<span class="token operator">&lt;</span>Image<span class="token operator">></span><span class="token punctuation">(</span>Trans<span class="token punctuation">,</span> <span class="token string">"组件层级名字"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>获取游戏物体，只保证 m_gameobj 下面有该游戏物体即可</p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>GameObject obj <span class="token operator">=</span> UIUtility<span class="token punctuation">.</span><span class="token function">Control</span><span class="token punctuation">(</span><span class="token string">"游戏物体名"</span><span class="token punctuation">,</span> m_gameobj<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div></li>
<li>
<p>获取变换组件</p>
