...
<ul>
<li>Main分包配置不建议修改</li>
<li>Main分包指向了<code>Assets/HotUpdateResources</code>下除了<code>AddOns</code>之外全部的子目录</li>
<li>在<code>Assets/HotUpdateResources/AddOns</code>内创建新文件夹，用来存放新分包内容，同时创建分包配置后将其资源路径指向创建到AddOns下的新分包资源目录</li>
<li>热更DLL会被加密，加密密钥在JEngine面板配置，同时Init场景下InitJEngine的加密密钥记得与打包时加密DLL的密码一致</li>
<li>加密DLL的秘钥和加密热更包的秘钥可以不一样</li>
<li>首包开启加密后，首包加密秘钥请输入到Updater，参考<RouterLink to="/zh/documents/pro/StartUp/">开始使用</RouterLink></li>
