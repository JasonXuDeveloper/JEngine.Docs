...
<li>创建实例（3种方法）
<ol>
<li>直接在编辑器内使用ClassBind挂载脚本<RouterLink to="/zh/documents/0.5/classbind.html">参考这里</RouterLink></li>
...
<p>下一篇，<RouterLink to="/zh/documents/0.5/jresource.html">资源加载JResource教程</RouterLink></p>
</blockquote>
</template>
