<template><h1 id="热更预制体解决方案-jprefab" tabindex="-1"><a class="header-anchor" href="#热更预制体解决方案-jprefab" aria-hidden="true">#</a> 热更预制体解决方案 JPrefab</h1>
...
<blockquote>
<p>下一篇，<RouterLink to="/zh/documents/0.5/ilruntime-tools.html">ILRuntime工具</RouterLink></p>
</blockquote>
</template>
