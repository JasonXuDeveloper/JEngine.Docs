...
<img src="/images/build-settings-remove-hot-scene.jpg" alt="guide4" style={{width: '50%', marginLeft: '25%'}} />



## 运行模式

<Callout type="info" title="JEngine可以使用三种模式运行游戏，分别是：开发模式，离线模式，真机模式">
...
<Callout type="info" title="资源服务器说明">
