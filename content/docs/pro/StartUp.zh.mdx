...
<Callout type="warn" title="1. 请使用仓库授权的GitHub账号">
...
<Callout type="warn" title="因为更新比较复杂，建议用版本控制工具保存项目，这样如果修改过源码，更新后也不怕遗漏">
...
4. 导入后不应该有报错，如果还有报错，请看[常见问题]https://jengine.xgamedev.net/v0.7/zh/guide/FAQ
5. 参考开源版0.8.x文档
