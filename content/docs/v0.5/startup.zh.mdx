...
3. 找到**HotUpdateResources/Scene**, 确保你能找到**Game.unity**，并且**HotUpdateResources/DLL/~Hidden文件夹中有生成的DLL文件（这个文件夹Unity内看不见）**
   ...
   <img src="/images/hot-update-resources-folder.png" alt="check1" style={{width: '50%', marginLeft: '25%'}} />

4. 找到并点击顶部导航栏中**JEngine/XAsset/Bundles/Build Bundles**选项

   <img src="/images/menu-build-bundles.png" alt="menu" style={{width: '75%', marginLeft: '12.5%'}} />
...
7. 进入**Init场景**，在阶级中选择**Updater**
   ...
   <img src="/images/init-scene-updater-hierarchy.png" alt="hierarchy" style={{width: '50%', marginLeft: '25%'}} />

8. 在**Inspector**中，将**BaseURL**换为您**存放资源的地址**

   > 格式: ```http://your-ip:your-port/DLC/``` 或 ```http://your-domain/DLC/```
   >
   > <img src="/images/updater-inspector-dev-mode.png" alt="inspector" style={{width: '50%', marginLeft: '25%'}} />

9. **Init场景中**，找到**HotFixCode**，Inspector中Init方法里的Key为DLL加密密码

  <img src="/images/init-scene-dll-encrypt-key.png" alt="guide1" style={{width: '50%', marginLeft: '25%'}} />
