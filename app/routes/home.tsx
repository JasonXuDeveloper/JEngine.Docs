...
import { ArrowRight, Flame, Package, Shield, Zap } from 'lucide-react';
...
const pageMeta: Record<Locale, { title: string; description: string }> = {
  en: {
    ...
    description:
      'Ship game updates without shipping a build. JEngine enables runtime hot updates across all Unity platforms with built-in encryption, code obfuscation, and superior performance via HybridCLR. Modular packages with AI-ready tooling.',
  },
  zh: {
    title: 'JEngine - Unity 热更新框架',
    description:
      '无需重新打包即可推送游戏更新。JEngine 支持全 Unity 平台运行时热更新，内置加密、代码混淆，基于 HybridCLR 实现卓越运行时性能。模块化包体系，开箱支持 AI 辅助开发。',
  },
};
